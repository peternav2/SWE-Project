...
// return new Date(year, month+1, 0).getDate();
  ...
  return (
    <div >
      ...
      <br></br>
      <button onClick={toDHalls} className={"w-full text-white border-blue-1000  bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center relative mb-4"}>
        Go To Dining Halls
      </button>
    </div>
  )
